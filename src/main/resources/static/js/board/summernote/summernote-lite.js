...
$(document).ready(function() {
  ...
  $('#summernote').summernote({
    ...
    maxHeight : null,
    toolbar : toolbar,
    placeholder: '개미는 뚠뚠은 여러분과 함께 생각과 의견을 존중하고 나누기 위해 만들어진 곳입니다. &#10; 성숙한 직장인 인터넷 문화를 만들어 나갈 수 있도록 도움 부탁드려요! &#8251;개미는 뚠뚠의 취지와 관련 없는 인신공격 및 허위사실 유포 글은 통보없이 즉시 삭제 처리 될 수 있습니다.',
  ...
  $(".node-modal-title").click(function(){
        alert('modal');
